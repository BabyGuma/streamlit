...
st.header("Dataset")
agree = sidebar.checkbox("Pica si quieres ver los pasajeros del titanic: ")
if agree:
 st.dataframe(titanic_data)

 # Select the embark town of the passanger and then display thedataset with this selection
...
sidebar.write(f"Number of Records With Fare Between {fare_min} and {fare_max}: {subset_fare.shape[0]}")
